...
function Hero() {
  return (
    <div className='text-white flex justify-between items-center py-14 lg:py-0 sm:m-auto'>
        <div className='p-14 space-y-10'>
            <h1 className="text-5xl sm:text-center sm:text-xl max-w-xl leading-snug font-['Poppins'] font-semibold">
