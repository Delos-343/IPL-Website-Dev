        ...
        <div className='flex items-center space-x-5'>
            <Link href='/'>
                <img 
                    ...
                    src='https://i.postimg.cc/hj6VHbD5/IPL-LOGO-15.png'
                    alt='logo'
                />
            </Link>
            <div className='hidden md:inline-flex items-center space-x-10 text-white hover:text-blue-600 font-semibold'>
                <h3>
