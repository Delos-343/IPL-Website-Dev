...
function Hero() {
  return (
    <div className="text-white flex relative justify-between items-center py-14 lg:py-0 font-['Poppins'] sm:m-auto">
        ...
        <img 
            className='hidden md:inline-flex h-32 lg:h-96 mt-10 mr-5'
            src='./logo-title.png'
            alt='logo'
        />
    </div>
